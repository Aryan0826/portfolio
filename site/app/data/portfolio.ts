...
const projectCatalog: Project[] = [
    {
        ...
        category: "Software",
        accent: "vermilion",
        status: "CYBERSECURITY BOOTCAMP WINNER",
        team: "Team of 2",
        summary:
            "A Chrome extension and web dashboard that help people check suspicious email and website links before opening them.",
        built: "Worked in a team of two to build a Chrome extension, responsive dashboard, and backend services with Python, Flask, Node.js, and Express. The tool combines VirusTotal threat intelligence with SSL certificate checks to analyze links in near real time.",
        reason: "We wanted to make link security easier to understand by turning technical threat data into a clear Safe or Risky result.",
        startedWith: "Python, JavaScript, and web-development fundamentals",
        learned:
            "How to build Chrome extensions, work with threat-intelligence APIs, evaluate SSL certificate signals, connect multiple backend services, and design with user privacy in mind.",
        challenge:
    ...
    },
    {
        ...
        built: "Worked with a five-person team to create daily, calendar, and upcoming-event views. Students can add, edit, delete, prioritize, and categorize events, attach notes, and track their progress. The app stores everything locally using SQLite.",
        reason: "We wanted to give students a simple way to see what is coming up and manage their schoolwork without juggling multiple calendars and to-do lists.",
        startedWith: "Java, and object-oriented programming",
        learned:
            "How to organize an Android app into clear UI, business, and data layers, Agile development practices, SOLID principles, Refactoring, and Testing.",
        challenge:
    ...
    },
    {
        ...
        startedWith: "Basic Java",
        learned:
            "Game engines, Understanding new languages, scope control, Git collaboration, and rapid decision-making",
        challenge:
    ...
    },
    {
        ...
        challenge:
            "Working with a team of beginners, and keeping the pace while also helping them learn the stack.",
        outcome:
    ...
    },
    {
        ...
        team: "Independent course research",
        summary:
            "A research report about how convolutional neural networks turn pixels into features such as edges, textures, object parts, and larger concepts.",
        built: "A research-based explanation of how CNNs learn features across their layers, what information they keep or lose, and how researchers study their internal behaviour using activation maps, saliency maps, feature visualization, and network inversion.",
        reason: "It started with a simple question: how do neural networks actually see and make sense of an image?",
        startedWith: "A little curiosity about how neural networks work",
        learned:
            "How CNNs build features layer by layer, how researchers inspect those features, and why a visualization does not always fully explain a model's decision.",
        challenge:
            "Turning complex ideas about CNNs, information theory, and human vision into a clear explanation without presenting uncertain ideas as proven facts.",
        outcome:
            "Finished with a clearer and more critical understanding of how CNNs process images and why looking inside a model is not the same as fully understanding it.",
        stack: [
    ...
    },
    {
        ...
        reason: "To replace repetitive manual verification with a consistent, safer community workflow and prevvent botting in the channel.",
        startedWith: "Basic Python knowledge",
        learned:
            "Discord APIs, event-driven services, secure role workflows, and cloud deployment",
        challenge:
            "Deploying the bot online and ensuring it is secure and reliable.",
        outcome:
