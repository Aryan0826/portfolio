...
export const projects: Project[] = [
  {
    ...
    built:
      'A browser extension, responsive web dashboard, and Python/Flask backend using the VirusTotal API, SSL certificate checks, and an Express service.',
    reason:
      'Security data is only useful when a person can understand it before trusting a link.',
    startedWith: 'Python and web-development fundamentals',
    learned: 'Browser extensions, threat-intelligence APIs, SSL signals, and cross-service design',
    challenge:
    ...
    stack: ['Python', 'Flask', 'Node.js', 'Express', 'JavaScript', 'VirusTotal API'],
    featured: true,
  },
  {
    ...
    built:
      'A research plan spanning robotic-system configuration, ethics materials, participant recruitment, experiment and workshop design, and qualitative data collection.',
    reason:
      'Continuous manual control is not always the most natural way for people to direct a robot.',
    startedWith: 'Hands-on robotics setup and software prototyping',
    learned: 'Research questions, ethics, user studies, qualitative methods, and experimental design',
    challenge:
    ...
    stack: ['HCI', 'Robotics', 'User Studies', 'Research Design', 'Qualitative Analysis'],
  },
  {
    ...
    built:
      'ROS 2 and Docker environments across Ubuntu and Windows for Kinova Gen3 Lite and SO-ARM101 hardware, including LeRobot tooling, cameras, USB devices, and motor configuration.',
    reason:
      'Robotics offered a way to test software decisions against the unpredictability of the physical world.',
    startedWith: 'Software development without deep hardware integration experience',
    learned: 'ROS 2, Linux device layers, robot calibration, teleoperation, drivers, and hardware debugging',
    challenge:
    ...
    stack: ['ROS 2', 'Docker', 'Ubuntu', 'Python', 'Kinova Gen3 Lite', 'LeRobot', 'SO-ARM101'],
  },
  {
    slug: 'studyflow',
    title: 'StudyFlow',
    ...
    built:
      'A layered Java application with repository and service patterns, SQLite persistence, calendar functionality, automated tests, Mockito, and Android integration testing.',
    reason:
      'To understand how a real application grows beyond isolated pieces of code without becoming difficult to change or test.',
    startedWith: 'Java and object-oriented programming',
    learned: 'Layered architecture, repositories, service boundaries, persistence, testing, and GitLab teamwork',
    challenge:
    ...
    stack: ['Java', 'Android', 'SQLite', 'Mockito', 'Integration Testing', 'GitLab'],
  },
  {
    ...
    built:
      'Node communication with UDP gossip, TCP client interfaces, heartbeats, timeouts, failure handling, and Byzantine-style consensus concepts.',
    reason:
      'To explore what coordination means when no machine can assume it holds the only source of truth.',
    startedWith: 'Sockets, processes, and core networking concepts',
    learned: 'Distributed state, gossip, failure detection, timeouts, and consensus reasoning',
    challenge:
  ...
  },
  {
    ...
    learned: 'FAT32 layout, binary structures, directory traversal, caching, profiling, and defensive parsing',
    challenge:
  ...
  },
  {
    ...
    built:
      'Gameplay systems and a complete jam-ready experience using Godot, GDScript, Blender, and Git.',
    reason:
      'To learn a completely different kind of development by making something tangible under a hard deadline.',
    startedWith: 'General programming experience, but no team game-development workflow',
    learned: 'Game engines, visual iteration, scope control, Git collaboration, and rapid decision-making',
    challenge:
  ...
  },
  {
    ...
    built:
      'A Flask application with project grading, dynamic leaderboard updates, Bootstrap UI, and a shared Git workflow.',
    reason:
      'To turn a real hackathon coordination problem into a working product inside one day.',
    startedWith: 'Python and early web-development experience',
    learned: 'Rapid product scoping, Git-based teamwork, live data flows, and deadline-driven delivery',
    challenge:
    ...
    stack: ['Python', 'Flask', 'JavaScript', 'Bootstrap', 'HTML/CSS', 'Git'],
  },
  {
    ...
    built:
      'A technical synthesis of CNN representations, information-bottleneck ideas, and interpretability methods such as Grad-CAM.',
    reason:
      'To move beyond using an AI model and ask what its internal representations can actually tell us.',
    startedWith: 'Foundational neural-network concepts',
    learned: 'CNN representation analysis, interpretability, Grad-CAM, and research communication',
    challenge:
    ...
    stack: ['CNNs', 'Grad-CAM', 'Information Bottleneck', 'Technical Writing'],
  },
  {
    ...
    built:
      'Facts, relationships, and inference rules that turn court conditions into an expert-style recommendation.',
    reason:
      'To explore intelligence as explicit knowledge and reasoning rather than statistical pattern learning.',
    startedWith: 'Imperative and object-oriented programming',
    learned: 'Declarative programming, knowledge representation, unification, and rule-based reasoning',
    challenge:
    ...
    stack: ['Prolog', 'Knowledge Bases', 'Logic Programming', 'Symbolic AI'],
  },
  {
    ...
    built:
      'A discord.py service with real-time validation, API-driven role assignment, and continuous deployment on Railway.',
    reason:
      'To replace repetitive manual verification with a consistent, safer community workflow.',
    startedWith: 'Python scripting',
    learned: 'Discord APIs, event-driven services, secure role workflows, and cloud deployment',
    challenge:
  ...
  },
  {
    ...
    startedWith: 'A vague idea for a website that felt like a personalized operating system',
    learned: 'Information architecture, progressive disclosure, interaction design, and disciplined visual systems',
    challenge:
...
export function getProjectNumber(project: Project) {
  return String(projects.findIndex((item) => item.slug === project.slug) + 1).padStart(2, '0');
}
...
export const journey: JourneyMilestone[] = [
  ...
  },
  {
    ...
    copy:
      'An Undergraduate Research Award project with Dr. Daniel Rea brought robotics and human-computer interaction together. The work now includes research questions, ethics, user-study design, workshop activities, and qualitative analysis.',
...
export const skillDomains = [
  {
    title: 'Applications',
    evidence: 'StudyFlow, CyberSentinel, HackAJudge, and deployed community tools',
    skills: ['Java', 'Python', 'JavaScript/TypeScript', 'React', 'Flask', 'Node.js', 'Android'],
  },
  {
    title: 'Systems & Networks',
    evidence: 'FAT32 parsing, processes, threads, sockets, and distributed consensus',
    skills: ['C', 'C++', 'Bash', 'LC-3 Assembly', 'TCP/UDP', 'Memory', 'Synchronization'],
  },
  {
    title: 'Data & Intelligence',
    evidence: 'Relational and graph data, symbolic reasoning, and neural-network research',
    skills: ['SQLite', 'SQL Server', 'PostgreSQL', 'Neo4j', 'R', 'Prolog', 'CNNs'],
  },
  {
    title: 'Robotics & Research',
    evidence: 'Real robot setup, teleoperation, HCI study design, and qualitative inquiry',
    skills: ['ROS 2', 'Docker', 'Ubuntu', 'Kinova', 'LeRobot', 'User Studies', 'Research Ethics'],
  },
];
...
export const experience = [
  ...
  {
    period: '2026',
    role: 'Undergraduate Research Award Researcher',
...
export const communities = [
  {
    ...
    period: '2024 - Present',
    contribution: 'Website and event-management software, technical planning, and team collaboration.',
  },
  {
    name: 'University of Manitoba Robotics Club',
    period: '2025 - Present',
    contribution: 'Embedded-systems discussions, component testing, and hardware/software integration.',
  },
  {
    name: 'UMSATS',
    period: '2025 - Present',
    contribution: 'Software and Command Data Handling work for satellite subsystems and mission simulations.',
  },
];
...
export const navItems = [
  { id: 'work', label: 'Work', command: 'work', number: '01', doorCopy: 'Systems I have built', accent: 'vermilion' },
  { id: 'journey', label: 'Journey', command: 'journey', number: '02', doorCopy: 'How the layers formed', accent: 'indigo' },
  { id: 'about', label: 'Manual', command: 'about', number: '03', doorCopy: 'How I operate', accent: 'peacock' },
  { id: 'contact', label: 'Connect', command: 'contact', number: '04', doorCopy: 'Start a conversation', accent: 'marigold' },
] as const;
